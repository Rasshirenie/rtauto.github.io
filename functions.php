...
function fallbackmenu(){ ?>
			<div id="submenu">
				<ul><li> Войдите в админку > Внешний вид > Меню чтобы создать собственное меню. У вас должен быть установлен Вордпресс версии 3 и выше.</li></ul>
			</div>
<?php }	
...
<?php wp_pagenavi() ?>
<?php else : ?>
        <div class="alignleft"><?php next_posts_link(__('&laquo; Предыдущие записи','web2feeel')) ?></div>
        <div class="alignright"><?php previous_posts_link(__('Следующие записи &raquo;','web2feel')) ?></div>
        <div class="clear"></div>
<?php endif; ?>
