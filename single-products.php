...
<div class="post" id="post-<?php the_ID(); ?>">
	<div class="prodmeta clearfix">
		<span class="procategori"> Рубрики продукта: <?php echo get_the_term_list( $post->ID, 'product-category', '', ', ', '' ); ?>   </span>
	</div>
	...
	<div class="entry">
		...
		<?php echo apply_filters('the_content', get_post_meta($post->ID, 'w2f_cartcode', true)); ?> 
		</div>
		<div class="clear"></div>
